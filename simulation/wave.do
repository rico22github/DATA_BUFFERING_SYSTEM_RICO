...
wave create -driver freeze -pattern clock -initialvalue 1 -period 10ps -dutycycle 50 -starttime 0ps -endtime 10000ps sim:/data_buffering_system/iclk 
...
wave create -driver freeze -pattern clock -initialvalue 1 -period 40ps -dutycycle 50 -starttime 0ps -endtime 10000ps sim:/data_buffering_system/oclk 
wave create -driver freeze -pattern constant -value 0 -starttime 0ps -endtime 10000ps sim:/data_buffering_system/empty_fifo 
wave modify -driver freeze -pattern constant -value 1 -starttime 800ps -endtime 840ps Edit:/data_buffering_system/empty_fifo 
wave modify -driver freeze -pattern constant -value 1 -starttime 760ps -endtime 800ps Edit:/data_buffering_system/empty_fifo 
wave modify -driver freeze -pattern constant -value 0 -starttime 0ps -endtime 10000ps Edit:/data_buffering_system/empty_fifo 
wave modify -driver freeze -pattern constant -value 1 -starttime 760ps -endtime 800ps Edit:/data_buffering_system/empty_fifo 
wave modify -driver freeze -pattern constant -value 1 -starttime 1240ps -endtime 1280ps Edit:/data_buffering_system/empty_fifo 
wave modify -driver freeze -pattern constant -value 1 -starttime 1640ps -endtime 1680ps Edit:/data_buffering_system/empty_fifo 
WaveCollapseAll -1
